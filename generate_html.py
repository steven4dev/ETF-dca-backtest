...
header p{{color:var(--muted);margin-top:.2rem;font-size:.84rem;}}

/* ── Control bar ── */
.ctrl-bar{{
  background:var(--card);border-bottom:1px solid var(--border);
  padding:.75rem 1.4rem;display:flex;flex-wrap:wrap;
...
/* ── Container ── */
.container{{max-width:1280px;margin:0 auto;padding:1.6rem 1.4rem;}}
.section-title{{
...
.kpi{{
  ...
  border-radius:10px;padding:.9rem;text-align:center;transition:border-color .2s;
}}
.kpi:hover{{border-color:var(--accent);}}
.kpi .val{{font-size:1.25rem;font-weight:700;}}
.kpi .lbl{{font-size:.7rem;color:var(--muted);margin-top:.15rem;}}
...
thead th{{
  padding:.55rem .85rem;text-align:right;color:var(--muted);
...
tbody td{{padding:.55rem .85rem;text-align:right;white-space:nowrap;}}
...
.tab-row{{display:flex;gap:.3rem;margin-bottom:.55rem;flex-wrap:wrap;}}
.tab-btn{{
  background:var(--border);color:var(--muted);border:none;
...
.c-card p,.c-card li{{font-size:.84rem;color:var(--muted);}}
.c-card ul{{padding-left:1rem;}}
.c-card li{{margin-bottom:.25rem;}}
.hl{{color:var(--text)!important;font-weight:600;}}
.gr{{color:var(--green)!important;}} .rd{{color:var(--red)!important;}}

/* ── No data notice ── */
.no-data{{
  text-align:center;padding:2.2rem;color:var(--muted);
  background:var(--card);border-radius:10px;border:1px dashed var(--border);
  margin-bottom:1.8rem;
}}

footer{{
  text-align:center;padding:1.2rem;color:var(--muted);
